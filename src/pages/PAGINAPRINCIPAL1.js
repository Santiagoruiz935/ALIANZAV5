import styles from "./PAGINAPRINCIPAL1.module.css";

const PAGINAPRINCIPAL1 = () => {
  return (
    <div className={styles.paginaPrincipal2}>
      ...
      <div className={styles.iniciarSesion}>{`Iniciar sesion `}</div>
      ...
      <div className={styles.pieDePaguinaParent}>
        ...
        <div className={styles.component33}>
          ...
          <div className={styles.ingresaYa}>INGRESA YA!</div>
        </div>
      </div>
    </div>
  );
...
export default PAGINAPRINCIPAL1;
